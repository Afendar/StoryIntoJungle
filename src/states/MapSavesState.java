 ...
 * 
 */
public class MapSavesState extends BaseState
{   
     ...
     * @param stateManager 
     */
    public MapSavesState(StateManager stateManager)
    {
        super(stateManager);
    }
    ...
    public void render(Graphics2D g)
    {
        ...
        g.setColor(new Color(160, 160, 160, 210));
    ...
    {
        m_stateManager.remove(StateType.MAP_SAVES);
    ...
    public void rebuildGui()
    {
        ...
        for(int i = 0 ; i <  bg.size(); i++)
        {
            ...
            else
            {
                ...
                JSONObject levelData = (JSONObject)saveData.get("level");
                ss.setData(
                    (int)playerData.get("sex"), 
                    (int)playerData.get("species"), 
                    (int)playerData.get("score"), 
                    (int)levelData.get("nbFreeCages"), 
                    (int)levelData.get("complete"), 
                    (int)playerData.get("difficulty"), 
                    (int)levelData.get("number"), 
                    (String)playerData.get("name")
                );
            }
        }
